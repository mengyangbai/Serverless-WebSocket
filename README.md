...
This is the code that follow the guideline of [simple-chat-app](https://github.com/aws-samples/simple-websockets-chat-app), add auto authoiry and enhance with proper functions.
